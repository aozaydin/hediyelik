...
var errorMsg = "";
		...
		function makeInput() {
			...
			for (i=1;i<=adet;i++) {
				$('#CustomForm').append('<input type="file" id="fotoUpload'+i+'" class="fotoyukleinput" accept="image/*"><label for="fotoUpload'+i+'" id="fLabel'+i+'" class="uploadButton box col-12 personalizationFormElement"><i class="fas fa-camera uploadicon"></i>'+i+'. Fotoğraf Yükle</label>');
			}
		}
